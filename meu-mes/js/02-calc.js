/*
  ...
  02-CALC.JS
  ═══════════════════════════════════════════════════════
  Regras de cálculo financeiro: ciclos, renda, gastos, blocos, diagnósticos, formatação e projeções.
...
// ═══════════════════════════════════════════════════════
      // CALC
      // ═══════════════════════════════════════════════════════
      /* Calc: biblioteca de cálculos financeiros usada por telas, alertas e relatórios. */
      const Calc = {
        fmt(v) {
