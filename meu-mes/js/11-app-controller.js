...
// ═══════════════════════════════════════════════════════
      ...
      const App = {
        ...
        async saveCartao() {
          ...
          const dataFechamento = document.getElementById("m-cart-fechamento")?.value || "";
          ...
          const fechamentoDt = parseData(dataFechamento);
          const vencimentoDt = parseData(dataVencimento);
          const diaFechamento = fechamentoDt ? fechamentoDt.getDate() : 0;
          const diaVencimento = vencimentoDt ? vencimentoDt.getDate() : 0;
          ...
          if (!fechamentoDt) {
            this.toast("Informe a data de fechamento");
            return;
          }
          if (!vencimentoDt) {
