...
// ═══════════════════════════════════════════════════════
      ...
      const Modals = {
        ...
        cartao(arg) {
          ...
          const fechamentoValue = c
            ? c.dataFechamento || dataPadraoPorDia(c.diaFechamento)
            : hoje;
        ...
        <div class="grid-2">
          <div class="form-group"><label class="label">Data de fechamento</label><input id="m-cart-fechamento" class="form-input" type="date" value="${fechamentoValue}"><div class="text-xs text-grey mt-4">Informe o próximo fechamento real da fatura.</div></div>
          <div class="form-group"><label class="label">Data de vencimento</label><input id="m-cart-vencimento" class="form-input" type="date" value="${vencimentoValue}"><div class="text-xs text-grey mt-4">Informe o próximo vencimento real da fatura.</div></div>
        </div>
        ...
        <div class="card-gold mb-16"><span class="eyebrow">como funciona</span><p class="body-text" style="margin:0;font-size:13px;">Cadastre as próximas datas reais de fechamento e vencimento. Depois disso, o app mantém o ciclo mensal automaticamente pelo mesmo dia, sem perder compatibilidade com cartões antigos.</p></div>
